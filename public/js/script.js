...
function toggleMenu(element) {
  ...
  const recommendedProducts = [
    { name: 'Pin', image: 'img/pin.png', price: '100RON'},
    { name: 'Cedru', image: 'img/cedru.png', price: '200RON'},
    { name: 'Podocarpus', image: 'img/podocarpus.png', price: '300RON'},
    { name: 'Glicina', image: 'img/glicina.png', price: '100RON'},
    { name: 'Agrișă', image: 'img/agrisa.png', price: '200RON'},
    { name: 'Hortensia', image: 'img/hortensia.png', price: '300RON'},
  ];
